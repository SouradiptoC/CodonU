...
def build_contingency_table_codon_rscu(handle: str, genetic_table_num: int, min_len_threshold: int = 200,
                                       save_file: bool = False, file_name: str = 'contingency_codon_rscu',
    ...
    **Note** Gene descriptions are index headings and codons are column headings
    ...
    if save_file:
        ...
        print(f'The Contingency table of codon RSCU can be found at: {abspath(file_path)}')
