...
def plot_ca_codon_rscu_codon(handle: str, genetic_table_num: int, min_len_threshold: int = 200, n_components: int = 2,
    ...
    sup_title = f'CA of Codon RSCU of {organism_name} [codons]' if organism_name \
        else 'CA of Codon RSCU [codons]'
    plt.suptitle(sup_title)

    if save_image:
        make_dir(folder_path)
        name = f'CA_codon_rscu_codon_{organism_name}.png' if organism_name else 'CA_codon_rscu_codon.png'
